...
func _initialize() -> void:
	...
	var glm_auto_formt_candidates: Array = page._formt_adapter_test_candidates("openai_api", "glm-5.1", "auto")
	...
	var glm_explicit_formt_candidates: Array = page._formt_adapter_test_candidates("openai_api", "glm-5.1", "openai_tool_forced")
	assert(glm_explicit_formt_candidates.size() == 1)
	assert(String(glm_explicit_formt_candidates[0]) == "openai_tool_forced")
