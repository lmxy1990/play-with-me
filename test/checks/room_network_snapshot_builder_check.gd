...
func _initialize() -> void:
	...
	var players := [
		...
		{"id": "p3", "name": "受控玩家", "owner": "human", "participant_id": "", "controller_participant_id": "peer_a", "device_id": "", "public_key": "", "bot_profile_id": "private-profile", "model": "private-model", "api_key": "sk-private", "endpoint": "https://private.example/v1", "modelProfile": {"api_key": "sk-nested"}, "formt_adapter": "openai_json_schema", "outputAdapter": "openai_json_schema", "reason_adapter": "native", "max_output": 4096, "temperature": 0.6},
	]
	...
	assert(not (peer_players[2] as Dictionary).has("voice"))
