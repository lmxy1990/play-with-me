...
| --- | --- | --- | --- | --- |
| [标准村庄](basic_village.md) | `basic_village` | `标准村庄规则` | 6、7、8、9 | 标准预女猎，默认地图。 |
| [猎人压力村](hunter_pressure_village.md) | `hunter_pressure_village` | `猎人压力村规则` | 6、7、8、9 | 提高猎人存在感，强化白天压力。 |
| [快节奏村庄](quick_no_witch_village.md) | `quick_no_witch_village` | `快节奏村庄规则` | 6、7、8、9 | 去掉女巫节奏，缩短夜晚分支。 |
| [守卫村庄](guard_village.md) | `guard_village` | `守卫村庄规则` | 6、7、8、9 | 启用守卫和连续守护限制。 |
| [警长广场](sheriff_square.md) | `sheriff_square` | `警长广场规则` | 10、12 | 启用警长竞选、警长发言顺序、警徽处理和警长票权。 |
| [警长守卫广场](sheriff_guard_square.md) | `sheriff_guard_square` | `警长守卫广场规则` | 12 | 警长发言顺序、警徽处理、警长票权和守卫流程同时启用。 |
